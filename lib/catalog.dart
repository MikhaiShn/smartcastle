...
import 'package:flutter_application_6/productsDetail.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: loading
          ? Center(child: CupertinoActivityIndicator()) // Если загрузка, показываем индикатор
          : GridView.builder(
          ...
          itemBuilder: ((context, index) {
            return GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => ProductsDetail(product: productsFromServer[index])));
              },
              child: Padding(
